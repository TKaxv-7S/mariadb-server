...
class Item_func_xml_method_getRootElement :public Item_str_func
{
public:
  Item_func_xml_method_getRootElement(THD *thd, Item *a):
    Item_str_func(thd, a) {}
  String *val_str(String *) override;
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name= {STRING_WITH_LEN("getRootElement") };
    return name;
  }
