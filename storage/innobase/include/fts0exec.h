...
private:
  ...
  fts_string_t m_last_word;
  mem_heap_t* m_word_heap= nullptr;
...
public:
  ...
  /** Get the last processed word (for pagination)
  @return reference to last processed word */
  const fts_string_t &get_last_word() const noexcept
  {
    return m_last_word;
  }
};
